...
R1 = ade.Molecule('p-fluorophenol',smiles='C1=CC(=CC=C1O)F', solvent_name='methanol', charge=0)
P1 = ade.Molecule('p-fluorophenolate',smiles='C1=CC(=CC=C1[O-])F',solvent_name='methanol', charge=-1)
