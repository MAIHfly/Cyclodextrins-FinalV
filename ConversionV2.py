...
bBiCyDNH_OMe = CombinedMolecule(bBiCyDNH_core, frag_smiles='C[*]', name='bBiCyDNH_New')
bBiCyDNH2_OMe = CombinedMolecule(bBiCyDNH2_core, frag_smiles='C[*]', name='bBiCyDNH2_New')
